...
% 
% modified Apr 2018 Henry Lewis duplicate first 10 frames to avoid losing
% info
...
% Duplicate first 10 images in stack
% for i = 1:10
% load frame i
% add to new stack
% end
% add new stack to old stack?
    % or
% run filter on new stack
% then use as baseline for real stack
% this
% dont even need to make new stack
% 
